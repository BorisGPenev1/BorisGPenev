...
if response.strip() == "1":
    ...
    while True:
        ...
        try:
            ...
            continue
        break
    if amt > 90000000000000000000:
        print("Sorry mate. You've just been scammed, it's against the law to give out more than 90000000000000000000 Dabloons at once!")
    else:
        update_balance(amt)
   ...
   creator = input()
   creator = 0   
   print("The creator is BorisGPenev")
